...
| Lesesaal | System to be created for the SFA's online access to meta and primary data, with a focus on search functionality (Information Retrieval) and services for users (Access and Research Services). |
