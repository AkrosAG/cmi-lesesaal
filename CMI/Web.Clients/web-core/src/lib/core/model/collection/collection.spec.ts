...
describe('Collection', () => {
	...
	beforeEach(() => {
		...
		TestBed.configureTestingModule({
			...
			providers: [
				{ useClass: Collection, multi: true }
			],
		});

	});
	it('Collection fromJS toJSON', () => {
		const result = Collection.fromJS(collection.toJSON());
	...
	it('Collection fromJS ', () => {
		const result = Collection.fromJS({
			collectionId: -1,
...
describe('CollectionListItem', () => {
	let collection = new CollectionListItem();
	...
	beforeEach(() => {
		...
		TestBed.configureTestingModule({
			...
			providers: [
				{ useClass: CollectionListItem, multi: true }
			],
		});

	});
	it('CollectionListItem fromJS toJSON', () => {
		const result = CollectionListItem.fromJS(collection.toJSON());
