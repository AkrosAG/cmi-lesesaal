...
namespace CMI.Access.Sql.Viaduc.EF
{
    ...
    public partial class ViaducDb : ObjectContext
    {
        ...
        /// </summary>
        public ViaducDb() :
                base(@"metadata=res://*/Viaduc.csdl|res://*/Viaduc.ssdl|res://*/Viaduc.msl;provider=System.Data.SqlClient;provider connection string=""Data Source=.\sqlexpress;Initial Catalog=viaduc;Integrated Security=True;Persist Security Info=True""", "ViaducDb")
        {
