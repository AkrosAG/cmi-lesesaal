...
namespace CMI.Access.Harvest
{
    ...
    public partial class Verzeichnungseinheit
    {
        ...
        public string Verwaltungssignatur { get; set; }
        ...
        public VerzeichnungseinheitCustomFields CustomFields { get; set; }
        public DateTimeFieldType SchutzfristBasisdatum { get; set; }
        public DateTimeFieldType SchutzfristEnddatum { get; set; }
        public string LinkZuPrimaerdaten { get; set; }
        public string LinkZuDigitalisat { get; set; }
        public string LinkAufDigitalesOriginal { get; set; }
        public string URL { get; set; }
        public string Erlaeuterung { get; set; }
        public string BemerkungStandort { get; set; }
        public string Lizenz { get; set; }
        public string BemerkungSprache { get; set; }
        public string ParentObject { get; set; }
        public string BemerkungUmfang { get; set; }
        public string Erwerbsarten { get; set; }
        public string Schadenserhebung { get; set; }
        public string Kuerzel { get; set; }
        public string Zustandskategorie { get; set; }
        [XmlAttribute]
        ...
        public Verzeichnungseinheit()
        {
            ...
            CustomFields = new VerzeichnungseinheitCustomFields();
    ...
    public partial class CustomField
    {
        ...
        private static XmlSerializer SerializerXml
        {
            get
            {
                if ((_serializerXml == null))
                {
                    _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(CustomField));
                }
                return _serializerXml;
            }
        }
        ...
        /// <summary>
        /// Deserializes CustomField object
        /// </summary>
        /// <param name="input">string to deserialize</param>
        /// <param name="obj">Output CustomField object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string input, out CustomField obj, out Exception exception)
        {
            exception = null;
            obj = default(CustomField);
            try
            {
                obj = Deserialize(input);
                return true;
        ...
        public static bool Deserialize(string input, out CustomField obj)
        {
            Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }

        public static CustomField Deserialize(string input)
        {
            StringReader stringReader = null;
            try
            {
                stringReader = new StringReader(input);
                return ((CustomField)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        public static CustomField Deserialize(Stream s)
        {
            return ((CustomField)(SerializerXml.Deserialize(s)));
        }
        #endregion

        /// <summary>
        /// Serializes current CustomField object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an CustomField object
        /// </summary>
        /// <param name="fileName">File to load and deserialize</param>
        /// <param name="obj">Output CustomField object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out CustomField obj, out Exception exception)
        {
            exception = null;
            obj = default(CustomField);
            try
        ...
        public static bool LoadFromFile(string fileName, out CustomField obj)
        {
            Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static CustomField LoadFromFile(string fileName)
        {
            FileStream file = null;
            StreamReader sr = null;
            try
    ...
    [DesignerCategoryAttribute("code")]
    [XmlTypeAttribute(AnonymousType = true, Namespace = "http://www.cmiag.ch/cdws/CMIArchiveRecord")]
    public partial class VerzeichnungseinheitCustomFields
    {
        private static XmlSerializer _serializerXml;
        [XmlElement("CustomField")]
        public CustomField Item { get; set; }

        public VerzeichnungseinheitCustomFields()
        {
        ...
        private static XmlSerializer SerializerXml
        {
            get
            {
                if ((_serializerXml == null))
                {
                    _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(VerzeichnungseinheitCustomFields));
                }
                return _serializerXml;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serialize VerzeichnungseinheitCustomFields object
        /// </summary>
        /// <returns>XML value</returns>
        public virtual string Serialize()
        {
        ...
        /// <summary>
        /// Deserializes VerzeichnungseinheitCustomFields object
        /// </summary>
        /// <param name="input">string to deserialize</param>
        /// <param name="obj">Output VerzeichnungseinheitCustomFields object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string input, out VerzeichnungseinheitCustomFields obj, out Exception exception)
        {
            exception = null;
            obj = default(VerzeichnungseinheitCustomFields);
            try
            {
                obj = Deserialize(input);
                return true;
        ...
        public static bool Deserialize(string input, out VerzeichnungseinheitCustomFields obj)
        {
            Exception exception = null;
            return Deserialize(input, out obj, out exception);
        }

        public static VerzeichnungseinheitCustomFields Deserialize(string input)
        {
            StringReader stringReader = null;
            try
            {
                stringReader = new StringReader(input);
                return ((VerzeichnungseinheitCustomFields)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        public static VerzeichnungseinheitCustomFields Deserialize(Stream s)
        {
            return ((VerzeichnungseinheitCustomFields)(SerializerXml.Deserialize(s)));
        }
        #endregion

        /// <summary>
        /// Serializes current VerzeichnungseinheitCustomFields object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an VerzeichnungseinheitCustomFields object
        /// </summary>
        /// <param name="fileName">File to load and deserialize</param>
        /// <param name="obj">Output VerzeichnungseinheitCustomFields object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out VerzeichnungseinheitCustomFields obj, out Exception exception)
        {
            exception = null;
            obj = default(VerzeichnungseinheitCustomFields);
            try
        ...
        public static bool LoadFromFile(string fileName, out VerzeichnungseinheitCustomFields obj)
        {
            Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static VerzeichnungseinheitCustomFields LoadFromFile(string fileName)
        {
            FileStream file = null;
            StreamReader sr = null;
            try
