...
namespace CMI.Access.Harvest
{
    ...
    public partial class AISDataAccess : IDbMutationQueueAccess, IDbMetadataAccess
    {
        ...
        public AISDataAccess(IArchiveRecordBuilder recordBuilder, DigitizationOrderBuilder digitizationOrderBuilder, IAISDataProvider dataProvider)
        {
        ...
        public async Task<ArchiveRecord> GetArchiveRecord(string archiveRecordId)
        {
        ...
        {
            return await dataProvider.UpdateMutationStatus(info);
        }
        ...
        {
            return await dataProvider.BulkUpdateMutationStatus(infos);
        }
