IF COL_LENGTH('[OrderItem]','TempStandort') IS NULL
ALTER TABLE [OrderItem] 
	ADD TempStandort NVARCHAR(MAX) NULL;
GO

IF OBJECT_ID('v_OrderingFlatItem', 'V') IS NOT NULL
    DROP VIEW v_OrderingFlatItem;
GO

CREATE VIEW [dbo].[v_OrderingFlatItem] AS
SELECT 
	i.Id AS ItemId,
	i.Ve AS VeId,
