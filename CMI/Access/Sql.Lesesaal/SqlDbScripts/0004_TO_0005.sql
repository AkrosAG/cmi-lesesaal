...
EXEC sys.sp_addextendedproperty @level1name=N'ApplicationUser', @value=N'Enthält Benutzer, die sich an Lesesaal angemeldet haben', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @name=N'MS_Description'
