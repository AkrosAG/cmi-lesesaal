...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:bar="http://bar.admin.ch/gebrauchskopie/v1" version="3.0"
  ...
  <xsl:template match="paket">
    <html lang="de">
      <head>
        ...
        <link rel="stylesheet" href="./design/css/gebrauchskopieCustomer.css"/>
      ...
      <body>
        <div class="container container-main">
          ...
          <div class="row root-content-wrapper #mainContent">
            <div class="col-xs-12">
      ...
      <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-sm-12 collapse" id="mehrMetadaten">
            ...
            <!-- Render Metadata Fields Conditionally -->
            <xsl:if test="$orderedItem/entstehungszeitraumAnmerkung">
              <xsl:call-template name="renderTextField">
            ...
            <xsl:if test="$orderedItem/zusatzmerkmal">
              <xsl:call-template name="renderTextField">
            ...
            <xsl:if test="$orderedItem/zusatzDaten/merkmal[@name = 'Früheres Aktenzeichen']">
              <xsl:call-template name="renderTextField">
            ...
            <xsl:if test="$orderedItem/zusatzDaten/merkmal[@name = 'Land']">
              <xsl:call-template name="renderTextField">
            ...
            <xsl:if test="$orderedItem/federfuehrendeOrganisationseinheit">
              <xsl:call-template name="renderTextField">
                <xsl:with-param name="label">Federführende Organisationseinheit</xsl:with-param>
            ...
            <xsl:if test="normalize-space($orderedItem/eroeffnungsdatum)">
            ...
            <xsl:if test="normalize-space($orderedItem/abschlussdatum)">
              <xsl:call-template name="renderHistorischerZeitpunktField">
            ...
            <xsl:if test="$orderedItem/klassifizierungskategorie">
              <xsl:call-template name="renderTextField">
                <xsl:with-param name="label">Klassifizierungskategorie</xsl:with-param>
            ...
            <xsl:if test="$orderedItem/datenschutz">
              <xsl:call-template name="renderBooleanField">
                <xsl:with-param name="label">Datenschutz</xsl:with-param>
            ...
            <xsl:if test="$orderedItem/oeffentlichkeitsstatus">
              <xsl:call-template name="renderTextField">
                <xsl:with-param name="label">Öffentlichkeitsstatus</xsl:with-param>
            ...
            <xsl:if test="$orderedItem/oeffentlichkeitsstatusBegruendung">
              <xsl:call-template name="renderTextField">
                <xsl:with-param name="label">Öffentlichkeitsstatus Begründung</xsl:with-param>
            ...
            <xsl:if test="$orderedItem/sonstigeBestimmungen">
              <xsl:call-template name="renderTextField">
            ...
            <xsl:if test="$orderedItem/zusatzDaten/merkmal[@name = 'Identifikation digitales Magazin']">
              <xsl:call-template name="renderTextField">
            ...
            <xsl:if test="$orderedItem/erscheinungsform">
              <xsl:call-template name="renderTextField">
            ...
            <xsl:if test="$orderedItem/bemerkung">
            <xsl:choose>
        ...
        <xsl:call-template name="renderMetadataRow">
          ...
          <xsl:with-param name="value">
            <xsl:call-template name="historischerZeitraum">
              <xsl:with-param name="zeitraum" select="$dokument/entstehungszeitraum[@name = 'Von']"/>
            </xsl:call-template>
          </xsl:with-param>
        </xsl:call-template>
        <xsl:call-template name="renderMetadataRow">
    ...
    <header>
      ...
      <div class="clearfix">
        <a href="/" class="brand hidden-xs">
          <img src="./design/img/logo.svg" onerror="this.onerror = null; this.src = './design/img/logo.svg'" alt="Logo der Hochschularchiv der ETH Zürich – zur Startseite"/>
          <div class="brand-header">
            	<h1 data-i18n="[html]viaduc-header-title">Hochschularchiv der ETH Zürich<br/>Virtueller Lesesaal<br/></h1><br/><br/>
            <xsl:choose>
  ...
  <xsl:template name="renderNavigation">
    <nav class="nav-main navbar">
      ...
      <!-- The tab navigation -->
      <ul class="nav navbar-nav cmi-viaduc-nav-content">
        <li class="dropdown">
  ...
  <xsl:template name="renderFooter">
    <footer>
      <div class="container-fluid">
        ...
        <img class="visible-xs" src="./design/img/logo.svg" onerror="this.onerror = null; this.src = './design/img/logo.png'" alt="back to home"/>
      </div>
