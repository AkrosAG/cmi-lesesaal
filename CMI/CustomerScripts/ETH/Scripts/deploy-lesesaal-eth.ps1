...
Function Install-Services
{
    ...
    Write-Host "Stoppe alle CMI.Host Prozesse ..."
    Get-Process -Name CMI.Host.* | ForEach-Object -Process {
        Write-Host "Stoppe" $PSItem.Name -NoNewline 
        try {
    ...
    Write-Host "CMI.Host Prozesse gestoppt."
